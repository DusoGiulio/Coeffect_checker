...
public static Triv fromNat( Nat n ){
 ...
 class Zero extends Nat { 
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------");
		System.out.println("	Metodo | met1");
		System.out.println("	----------------------------------------");
		System.out.println("	Variabili | ");
		System.out.println("	----------------------------------------");
		System.out.println("	----------------------------------------");
		System.out.println("	Metodo | zero");
		System.out.println("	----------------------------------------");
		System.out.println("	Variabili | ");
		System.out.println("	----------------------------------------");
		System.out.println( "	b |"+(Nat.one().leq(Nat.one())));
		System.out.println("	coeffetto variabile: "+"Nat.one()");
		System.out.println("	coeffetto inferito: "+((Nat.one())).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println( "	this |"+(Nat.one().leq(Nat.one())));
		System.out.println("	coeffetto variabile: "+"Nat.one()");
		System.out.println("	coeffetto inferito: "+((Nat.one())).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println("	----------------------------------------");
		...
		System.out.println("	----------------------------------------");
		System.out.println("	----------------------------------------");
		System.out.println("	Metodo | xy");
		System.out.println("	----------------------------------------");
		System.out.println("	Variabili | ");
		System.out.println("	----------------------------------------");
		System.out.println( "	z |"+((Affinity.fromNat(Nat.one().sum(Nat.one()).sum(Nat.one().sum(Nat.one())).mult(Nat.one().sum(Nat.one())))).leq(new Omega())));
		System.out.println("	coeffetto variabile: "+"new Omega()");
		System.out.println("	coeffetto inferito: "+((Nat.one().sum(Nat.one()).sum(Nat.one().sum(Nat.one())).mult(Nat.one().sum(Nat.one())))).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println( "	x1 |"+((Affinity.fromNat(Nat.one().sum(Nat.one()).sum(Nat.one().sum(Nat.one())))).leq(new Omega())));
		System.out.println("	coeffetto variabile: "+"new Omega()");
		System.out.println("	coeffetto inferito: "+((Nat.one().sum(Nat.one()).sum(Nat.one().sum(Nat.one())))).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println( "	y2 |"+((Affinity.fromNat(Nat.one())).leq(new Omega())));
		System.out.println("	coeffetto variabile: "+"new Omega()");
		System.out.println("	coeffetto inferito: "+((Nat.one())).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println("	----------------------------------------");
		System.out.println("	Metodo | omega");
		System.out.println("	----------------------------------------");
		System.out.println("	Variabili | ");
		System.out.println("	----------------------------------------");
		System.out.println( "	a1 |"+(new Omega().sup(Affinity.fromNat(Nat.one())).mult(Affinity.fromNat(Nat.one())).leq(new Omega())));
		System.out.println("	coeffetto variabile: "+"new Omega()");
		System.out.println("	coeffetto inferito: "+((new Omega().sup(Affinity.fromNat(Nat.one())).mult(Affinity.fromNat(Nat.one())))).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println( "	a2 |"+((Affinity.fromNat(Nat.one())).leq(Affinity.one())));
		System.out.println("	coeffetto variabile: "+"Affinity.one()");
		System.out.println("	coeffetto inferito: "+((Nat.one())).getClass().getSimpleName());
		System.out.println("	----------------------------------------");
		System.out.println("	----------------------------------------");
